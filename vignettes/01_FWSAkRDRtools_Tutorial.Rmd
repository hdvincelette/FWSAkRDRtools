...
```{r, echo = FALSE, out.width = "50%", out.height = "20%", fig.cap = "*The Alaska Regional Data Repository in File Explorer (left) and Microsoft Edge (right).*", fig.show = 'hold', fig.align = 'left'}
