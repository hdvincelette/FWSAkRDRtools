...
```{r, echo = FALSE, out.width = "40%", out.height = "20%", fig.cap = "The Alaska Regional Data Repository in File Explorer (left) and Microsoft Edge (right).", fig.show = 'hold', fig.align = 'center'}
knitr::include_graphics(c("man/figures/RDR_file_explorer.png", "man/figures/RDR_web_browser.png"))
```
