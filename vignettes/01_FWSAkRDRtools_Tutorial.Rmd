...
```{r, echo = FALSE, out.width = "100%", out.height = "20%", fig.cap = "The Alaska Regional Data Repository in File Explorer (left) and Microsoft Edge (right).", fig.show = 'hold', fig.align = 'center'}
knitr::include_graphics(c(normalizePath("RDR_file_explorer.png"), normalizePath("RDR_web_browser.png")), error = FALSE)
```
