...
knitr::include_graphics(c(paste0(getwd(),"/vignettes/images/RDR_file_explorer.png"),paste0(getwd(),"https://github.com/hdvincelette/FWSAkRDRtools/tree/main/vignettes/images/RDR_web_browser.png")), error = FALSE)
```
